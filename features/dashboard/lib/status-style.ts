...
export const statusBadgeClass = {
  success: "border-green-500/40 bg-green-500/15 text-green-700 dark:text-green-400",
  warning: "border-amber-500/40 bg-amber-500/15 text-amber-700 dark:text-amber-400",
